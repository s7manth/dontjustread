...
export async function POST(req: NextRequest) {
  try {
    ...
    const system =
      "You are a helpful reading assistant. Explain the contextual meaning of the selected text from a book in simple terms. Keep it concise and focused on what the selection means in this context.";
